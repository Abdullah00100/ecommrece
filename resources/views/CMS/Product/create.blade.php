                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    <div class="input-group">
                        ...
                        <input type="text" required
                            ...
                            placeholder="title" aria-label="title" value="{{ old('title') }}"
                            name='title' />
                        @if ($errors->has('title'))
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" required
                            ...
                            placeholder="Price" aria-label="price" value="{{ old('price') }}"
                            name='price' />
                        @if ($errors->has('price'))
                            <span class="invalid-feedback text-right" style="display: block;" role="alert">
                    ...
                    <div class="input-group">
                        ...
                        <textarea type="text" required
                            ...
                            placeholder="Description" aria-label="description" value="{{ old('description') }}"
